...
enum SpellAuraInterruptFlags
{
    ...
    AURA_INTERRUPT_FLAG_JUMP                = 0x00000020,   // 5    removed by entering combat      TODO: entering combat or jump ?
...
enum SpellModOp
{
    ...
    SPELLMOD_EFFECT2                = 12,
    SPELLMOD_IGNORE_ARMOR           = 13, // Maybe usefull for 2.4.3 ignore armor implemention
    SPELLMOD_COST                   = 14,
...
enum UnitBytes1_Flags
{
    ...
    UNIT_BYTE1_FLAG_HOVER           = 0x02,                 // not implemented in 2.4.3
    UNIT_BYTE1_FLAG_UNK_3           = 0x04,                 // untrackable ?
...
{
    UNIT_BYTE2_FLAG_UNK0        = 0x01,                     // not used
...
// byte flags value (UNIT_FIELD_BYTES_2,3)
enum ShapeshiftForm
{
    FORM_NONE               = 0x00,
    FORM_CAT                = 0x01,
...
class Unit : public WorldObject
{
    public:
        ...
        void SendHealSpellLog(Unit* victim, uint32 SpellID, uint32 Damage, uint32 OverHeal, bool critical = false);
        ...
        void SetCritterGUID(uint64 guid) { /* Not implemented in 2.4.3 --- SetUInt64Value(UNIT_FIELD_CRITTER, guid); */ }
        uint64 GetCritterGUID() const { return 0; /* Not implemented in 2.4.3 --- GetUInt64Value(UNIT_FIELD_CRITTER); */ }
        ...
        void RemoveAurasWithFamily(SpellFamilyNames family, uint32 familyFlag1, uint32 familyFlag2, uint64 casterGUID);
        ...
        AuraEffect* GetAuraEffect(AuraType type, SpellFamilyNames family, uint32 familyFlag1, uint32 familyFlag2, uint64 casterGUID =0) const;
