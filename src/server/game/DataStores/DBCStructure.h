...
struct SpellEntry
{
    ...
    //uint32    EffectBaseDice[MAX_SPELL_EFFECTS];            // 71-73
    ...
    //uint32    spellPriority;                              // 126 not used
...
struct SpellRangeEntry
{
    ...
    float     maxRange;
    uint32    type;
    //char*     Name[16];                                   // 5-21 unused
    // 22 string flags, unused
    //char*     Name2[16];                                  // 23-38 unused
    // 39 string flags, unused
};
...
{
    uint32      ID;                                         // 0        m_ID
    uint32      type[MAX_ITEM_ENCHANTMENT_EFFECTS];         // 1-3      m_effect[MAX_ITEM_ENCHANTMENT_EFFECTS]
    uint32      amount[MAX_ITEM_ENCHANTMENT_EFFECTS];       // 4-6      m_effectPointsMin[MAX_ITEM_ENCHANTMENT_EFFECTS]
    //uint32      amount2[MAX_ITEM_ENCHANTMENT_EFFECTS]     // 7-9      m_effectPointsMax[MAX_ITEM_ENCHANTMENT_EFFECTS]
    uint32      spellid[MAX_ITEM_ENCHANTMENT_EFFECTS];      // 10-12    m_effectArg[MAX_ITEM_ENCHANTMENT_EFFECTS]
    char*       description[16];                            // 13-28    m_name_lang[16]
    //uint32      descriptionFlags;                         // 29       name flags
