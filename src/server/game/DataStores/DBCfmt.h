...
char const AreaTableEntryfmt[] = "iiinixxxxxissssssssssssssssxiiiiixx";
...
char const SpellEntryfmt[] = "nixiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifxiiiiiiiiiiiiiiiiiiiiiiiiiiiixxxxxxfffiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiifffiiiixssssssssssssssssxssssssssssssssssxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxiiiiiiiiiixfffxxxiiii";
